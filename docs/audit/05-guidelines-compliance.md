...
| Admin table access boundary | Pass | Metadata-backed catalog is read-only by default; only audited, step-up-protected users, courier profiles, and eligible order detail edits are exposed. |
